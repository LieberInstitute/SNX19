#qsub -l bluejay -l mf=5G,h_vmem=15G,h_stack=256M -M stephensemick@gmail.com -cwd -b y R CMD BATCH --no-save run_DLPFC_RiboZero_eqtls.R
...
library(matrixStats)
setwd('/dcl01/lieber/ajaffe/Steve/SNX19/eqtl_runs/DLPFC_RiboZero')
## load counts
...
save(all3PCs, file="rdas/all3Feature_PCs_DLPFC_RiboZero_age13_matchedUp.rda")
...
save(eqtl, file = '/dcl01/lieber/ajaffe/Steve/SNX19/eqtl_runs/DLPFC_RiboZero/rdas/rawEqtls_DLPFC_RiboZero_age13_merged.rda' )