#qsub -l bluejay -l mf=5G,h_vmem=15G,h_stack=256M -M stephensemick@gmail.com -cwd -b y R CMD BATCH --no-save run_DLPFC_PolyA_eqtls_sexOnly.R
...
save(all3PCs, file="rdas/all3Feature_PCs_DLPFC_polyA_age13_matchedUp.rda")
...
save(eqtl, file = '/dcl01/lieber/ajaffe/Steve/SNX19/eqtl_runs/DLPFC_polyA/rdas/rawEqtls_DLPFC_polyA_age13_merged.rda')