#qsub -l bluejay -l mf=5G,h_vmem=15G,h_stack=256M -M stephensemick@gmail.com -cwd -b y R CMD BATCH --no-save run_CMC_DLPFC_eqtls.R
...
library(matrixStats)
setwd('/dcl01/lieber/ajaffe/Steve/SNX19/eqtl_runs/CMC')
## load counts
...
mm = match(pd$Genotyping_Sample_ID, colnames(snpAll ))
...
save(all3PCs, file="rdas/all3Feature_PCs_CMC_DLPFC_age13_matchedUp.rda")
...
save(eqtl, file = '/dcl01/lieber/ajaffe/Steve/SNX19/eqtl_runs/CMC/rdas/rawEqtls_CMC_DLPFC_age13_merged.rda')