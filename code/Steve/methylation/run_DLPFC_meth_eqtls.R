#qsub -l bluejay -l mf=15G,h_vmem=25G,h_stack=256M -M stephensemick@gmail.com -cwd -b y R CMD BATCH --no-save run_DLPFC_meth_eqtls.R
...
library(matrixStats)
setwd('/dcl01/lieber/ajaffe/Steve/SNX19/meqtl_runs/DLPFC')
## load counts
...
#save(pca_meth, file="rdas/meth_PCs_DLPFC_polyA_age13_matchedUp.rda")
#
#########################
### set up model matrix
